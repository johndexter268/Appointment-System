    ...
    <div className="min-h-screen relative overflow-hidden" style={{ 
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-2 bg-gradient-to-r from-[#69a5ff] to-[#14b5ff] text-transparent bg-clip-text">
            About Us
          </h1>
          <p className="text-[#14b5ff] text-center mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-[#d9ebfb] mb-8">
            ...
            <h2 className="text-2xl font-bold text-[#14b5ff] mb-6">Our System's Core Principles</h2>
            
            <ol className="space-y-4 text-[#000000]/80 list-decimal pl-6">
              <li className="pl-2">
          ...
          <h2 className="text-2xl font-bold text-[#14b5ff] mb-6 text-center">The Visionaries</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-[#d9edfb] flex flex-col items-center">
              ...
              <h3 className="text-md font-bold text-[#14b5ff] mb-1">Janna Mae P. Macale</h3>
              <p className="text-[#14b5ff]/80 text-center text-sm">
              Proponent
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-[#d9edfb] flex flex-col items-center">
              ...
              <h3 className="text-md font-bold text-[#14b5ff] mb-1">Carl Marius M. Lacuata</h3>
              <p className="text-[#14b5ff]/80 text-center text-sm">
                Proponent
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-[#d9edfb] flex flex-col items-center">
              ...
              <h3 className="text-md font-bold text-[#14b5ff] mb-1">Mariah Altea E. Lacsamana</h3>
              <p className="text-[#14b5ff]/80 text-center text-sm">
                Proponent
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-[#d9edfb] flex flex-col items-center">
              ...
              <h3 className="text-md font-bold text-[#14b5ff] mb-1">Ponce Erhomar V. Leus</h3>
              <p className="text-[#14b5ff]/80 text-center text-sm">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-[#d9edfb] flex flex-col items-center">
              ...
              <h3 className="text-md font-bold text-[#14b5ff] mb-1">Genesis U. Llaneras </h3>
              <p className="text-[#14b5ff]/80 text-center text-sm">
                Proponent
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-[#d9edfb] flex flex-col items-center">
              ...
              <h3 className="text-md font-bold text-[#14b5ff] mb-1">Justin Agustin</h3>
              <p className="text-[#14b5ff]/80 text-center text-sm">
                Developer
              </p>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-[#d9edfb]">
            <h2 className="text-2xl font-bold text-[#14b5ff] mb-4">Our Commitment</h2>
